...
class StatusCrm(models.Model):
    status_name = models.CharField(max_length=200, verbose_name='Название вашего статуса')
...
class Order(models.Model):
    ...
    order_status = models.ForeignKey(StatusCrm, on_delete=models.PROTECT, null=True, blank=True, verbose_name='Ваш статус')
